...
`define SDFFILE    "/home/host/Documents/Yan-j/IC-contest/2019_init/_syn/CONV_syn.sdf"	  // Modify your sdf file name
`define End_CYCLE  1000000              // Modify cycle times once your design need more cycle times!

`define PAT        "/home/host/Documents/Yan-j/IC-contest/2019_init/verification/rtl_sim/cnn_sti.dat"                 // Modify your "dat" directory path
`define L0_EXP0    "/home/host/Documents/Yan-j/IC-contest/2019_init/verification/rtl_sim/cnn_layer0_exp0.dat"
`define L1_EXP0    "/home/host/Documents/Yan-j/IC-contest/2019_init/verification/rtl_sim/cnn_layer1_exp0.dat"
         ...
         if (check0 == 1) begin
             ...
             for (p0=0; p0<=4095; p0=p0+1) begin
                 if (L0_MEM0[p0] == L0_EXP0[p0])
                     ;//判斷 計算答案LO_MEMO 是否等於 正確答案LO_EXPO
                 else begin
                     err00 = err00 + 1;
                     begin
